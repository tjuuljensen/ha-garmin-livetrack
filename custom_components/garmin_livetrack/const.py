...
CONF_NOTIFICATION_START_TEMPLATE='notification_start_template'
CONF_NOTIFICATION_END_TEMPLATE='notification_end_template'
...
DEFAULT_NOTIFICATION_START_TEMPLATE='LiveTrack started: {user} ({activity})'
DEFAULT_NOTIFICATION_END_TEMPLATE='LiveTrack ended: {user} ({activity}) - {reason}'
DEFAULT_USER_AGENT='HomeAssistant-GarminLiveTrack/0.1.1'
